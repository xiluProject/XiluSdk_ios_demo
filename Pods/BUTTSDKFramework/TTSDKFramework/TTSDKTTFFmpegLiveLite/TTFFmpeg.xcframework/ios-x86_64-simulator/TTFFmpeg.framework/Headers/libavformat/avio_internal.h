...
/** @warning must be called before any I/O */
int ffio_set_buf_size_opt(AVIOContext *s, int buf_size, int enable_ffio_opt);
...
int ffio_stitch_partial_packet(AVIOContext *s, AVPacket *pkt, int size, AVBufferRef *read_buf, int read_buf_size);

int ffio_read_packet_with_copy(AVIOContext *s, AVPacket *pkt, int size);

int ffio_read_packet2(AVIOContext *s, AVPacket* pkt, int size);
