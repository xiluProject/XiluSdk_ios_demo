...
typedef struct MOVContext {
    ...
    int optimize_read_packet;
    int find_nearest_sample;
    int64_t max_av_pos;
    int64_t max_av_pts;
    ...
    int skip_log_fourcc;
    int use_avio_read_packet2;
    int disable_seek_back;
    int fix_ignore_fmp4_drm_seek;
    int enable_ffio_set_buf_size_opt;
    int enable_trun_read_pts_opt;
} MOVContext;
