...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=arm64 --cc='xcrun -sdk iphoneos clang' --disable-shared --disable-symver --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-protocols --enable-fft --disable-rdft --enable-pthreads --disable-parsers --disable-demuxers --disable-muxers --disable-filters --disable-encoders --disable-decoders --disable-devices --disable-bsfs --enable-nonfree --enable-network --enable-swscale --enable-swresample --enable-avresample --enable-hwaccels --enable-decoder=h264 --enable-asm --disable-gpl --disable-version3 --disable-postproc --disable-libopencore_amrnb --disable-libopencore_amrnb --disable-libopencore_amrwb --disable-libvo_amrwbenc --disable-libxavs --disable-libmp3lame --disable-libxvid --enable-demuxer=flv --enable-demuxer=mov --enable-demuxer=hls --enable-protocol=hls --enable-protocol='tls*' --enable-protocol=http --enable-protocol=https --enable-protocol=httpproxy --enable-protocol=hlsproxy --enable-protocol=rtmp --enable-protocol=tcp --enable-filter=format --enable-filter=aformat --enable-filter=aresample --enable-filter=atempo --enable-filter=scale --disable-symver --enable-zlib --enable-stripping --enable-logging --disable-indevs --disable-outdevs --disable-version3 --enable-small --enable-optimizations --enable-debug --disable-openssl --enable-protocol=tls_securetransport --disable-libfdk_aac --disable-libx264 --enable-drm --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=opus --enable-demuxer=aac --enable-demuxer=h264 --enable-demuxer=opus --enable-parser=aac --enable-demuxer=mpegts --enable-demuxer=mpegtsraw --enable-demuxer=llash --enable-parser=aac_latm --enable-protocol=mem --disable-decoder=libbytevc2 --enable-cross-compile --enable-pic --extra-cflags='-arch arm64 -mios-version-min=9.0 -o3 -fPIC -Wno-error=incompatible-function-pointer-types -I/Applications/Xcode-15.1.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS17.2.sdk/usr/include/libxml2' --extra-ldflags='-arch arm64 -mios-version-min=9.0 -o3 -fPIC -Wno-error=incompatible-function-pointer-types -lxml2' --prefix=/Users/3hnh77edltalgjatqnra8ul53/52815/ttffmpeg/ios/contrib/build/ffmpeg-arm64"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/3hnh77edltalgjatqnra8ul53/52815/ttffmpeg/ios/contrib/build/ffmpeg-arm64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/3hnh77edltalgjatqnra8ul53/52815/ttffmpeg/ios/contrib/build/ffmpeg-arm64/share/ffmpeg"
...
#define CONFIG_BORINGSSLVERIFY 0
...
#define CONFIG_DASHPROXY_PROTOCOL 0
...
#define CONFIG_HTTPS_ANDROID_PROTOCOL 0
