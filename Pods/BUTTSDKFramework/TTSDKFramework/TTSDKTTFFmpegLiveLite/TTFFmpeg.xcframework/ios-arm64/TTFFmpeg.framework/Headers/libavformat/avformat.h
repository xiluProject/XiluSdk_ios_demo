...
int av_probe_input_buffer3(AVFormatContext *s, AVInputFormat **fmt,
const char *filename, void *logctx,
unsigned int offset, unsigned int max_probe_size,  AVDictionary **options);
