...
#define AVSEEK_SUPPORT_READ_BUFFER_REF 0x7002
...
typedef struct AVIOCustomClass {
    const AVClass av_class;
    int (*read_packet2)(void *opaque, AVBufferRef** buf, int buf_size);
} AVIOCustomClass;

const AVClass* avio_get_custom_class(void);
